      ...
      <div className="home-content">
        <div>
          <section className="hero">
            <small style={{ marginTop: '4rem', marginBottom: '1rem' }}>A Kswap project</small>
            ...
            <p>
              Kiwkswap is a token marketplace that faces the issues of token reputation directly. Until now, the Kwikswap
              team took on the responsibility of curating the tokens that show up in the Kwikswap Interface. While this
              was important to get the project off the ground and protect the users of Kwikswap, having the Kwikswap team
            ...
            <p>
              ...
              That power residing solely in the Kwikswap team was against the ethos of the protocol and the broader DeFi
              ecosystem.
            </p>
