...
import logo from '../logo/kswap_logo_white.png'
...
export default function Header({ back }) {
  return (
    <StyledHeader>
      ...
      <Nav>
        <a target="_blank" rel="noopener noreferrer" className="hide-small" href="https://kwikswap.org/">
          Support
        </a>
        <a
          target="_blank"
        ...
        <ButtonLink
          ...
          target="_blank"
          rel="noopener noreferrer"
          href="https://github.com/kwikswap/token-lists"
        >
          <img
            style={{
              filter: 'invert(1)',
